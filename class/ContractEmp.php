...
class ContractEmp extends Employee
{
    private $id;
    private $salary;
    private static $contractEmpNumbers = 0;

    public function __construct($name, $email, $salary)
    {
        parent::__construct($name, $email);
        $this->setSalary($salary);
        $this->id = ++self::$contractEmpNumbers;
    }
    ...
    public function Details()
    {
        ...
        echo "<pre>Employee Type:  Contract";
    ...
    {
        echo "<pre> emp: " . $this->getName() . " from contract employee section welcome in our company";
    }

      public  static function getContractEmpNumbers(){
        return self::$contractEmpNumbers;
    }
}
